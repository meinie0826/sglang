...
class Envs:
    ...
    SGLANG_WINDOW_TTFT_PREDICTOR_WINDOW_SECONDS = EnvFloat(60.0)
    SGLANG_WINDOW_TTFT_PREDICTOR_TRAINING_WINDOW_SECONDS = EnvFloat(900.0)
    SGLANG_WINDOW_TTFT_PREDICTOR_RETRAIN_INTERVAL_SECONDS = EnvFloat(30.0)
    SGLANG_WINDOW_TTFT_PREDICTOR_MODEL_PATH = EnvStr("")
    SGLANG_WINDOW_TTFT_PREDICTOR_EVENT_LOG_PATH = EnvStr("")
    SGLANG_WINDOW_TTFT_PREDICTOR_FUTURE_QPS_VALUES = EnvStr("")
    SGLANG_WINDOW_TTFT_PREDICTOR_FUTURE_QPS_INTERVAL_SECONDS = EnvFloat(30.0)
    SGLANG_WINDOW_TTFT_PREDICTOR_FUTURE_QPS_LOG_PATH = EnvStr("")
    SGLANG_WINDOW_TTFT_PREDICTOR_FUTURE_QPS_MATCH_TOLERANCE = EnvFloat(0.1)
    SGLANG_WINDOW_TTFT_PREDICTOR_FUTURE_QPS_HORIZON_SECONDS = EnvStr("15,30,60")
